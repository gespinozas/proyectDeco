                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>RAZON TRIGONOMETRICA</div>
                                </div>
                            </div>
                        </div>
                        <a href="topicsMatter/T019.jsp">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>REDUCCION AL PRIMER CUADRANTE</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>CIRCUNFERENCIA TRIGONOMETRICAS I</div>
                                </div>
                            </div>
                        </div>
                        <a href="topicsMatter/T021.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">Comenzar!</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>CIRCUNFERENCIA TRIGONOMETRICAS II</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>IDENTIDADES TRIGONOMETRICAS I</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
