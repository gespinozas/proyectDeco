...
<head>
    ...
    <title>BOOM LATINOAMERICANO</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">BOOM LATINOAMERICANO</h3>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) Alfonsina Stomi</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) Gabriela Mistral</p>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>5.- No comprende a la Nueva narrativa</p>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>6.- No es escritor que pertenece a la Nueva narrativa</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R6" value="a" onclick="Engine(6,value)"/>a) Juan Rulfo</p>
                <p><input type="radio" name="R6" value="b" onclick="Engine(6,value)"/>b) Julio Cortazar</p>
                <p><input type="radio" name="R6" value="c" onclick="Engine(6,value)"/>c) Miguel Angel Asturias</p>
                <p><input type="radio" name="R6" value="d" onclick="Engine(6,value)"/>d) N.A</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>7.- Narrador mexicano de la Nueva narrativa, autor de los cuentos "El hombre", "Diles que no me maten"</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R7" value="a" onclick="Engine(7,value)"/>a) Jose Donoso</p>
                <p><input type="radio" name="R7" value="b" onclick="Engine(7,value)"/>b) Alejo Carpentier</p>
                <p><input type="radio" name="R7" value="c" onclick="Engine(7,value)"/>c) Juan Rulfo</p>
