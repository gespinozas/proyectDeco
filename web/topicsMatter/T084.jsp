    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R1" value="b" onclick="Engine(1,value)"/>b) Manu</p>
                <p><input type="radio" name="R1" value="c" onclick="Engine(1,value)"/>c) Inambari</p>
                <p><input type="radio" name="R1" value="d" onclick="Engine(1,value)"/>d) Tambopata </p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) De las Piedras</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) Inambari </p>
                <p><input type="radio" name="R3" value="d" onclick="Engine(3,value)"/>d) Heath</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
