...
<head>
    ...
    <title>FONEMAS Y GRAFEMAS</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">FONEMAS Y GRAFEMAS</h3>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>2.- Marca la alternativa en la que un grafema represente a dos fonemas distintos </p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R2" value="a" onclick="Engine(2,value)"/>a) Sensualidad</p>
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) Avivar</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) Concentrar</p>
                <p><input type="radio" name="R2" value="d" onclick="Engine(2,value)"/>d) barbudo</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>5.-  El estudio del fonema le corresponde a: </p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R6" value="d" onclick="Engine(6,value)"/>d) 8</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R7" value="c" onclick="Engine(7,value)"/>c) 13</p>
                <p><input type="radio" name="R7" value="d" onclick="Engine(7,value)"/>d) 12</p>
            </div>
        </div>
        <div align="center">
