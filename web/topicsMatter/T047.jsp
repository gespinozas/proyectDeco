...
<head>
    ...
    <title>MODERNISMO Y POSTMODERNISMO</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">MODERNISMO Y POSTMODERNISMO</h3>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R1" value="b" onclick="Engine(1,value)"/>b) Federico More</p>
                <p><input type="radio" name="R1" value="c" onclick="Engine(1,value)"/>c) Alberto Hidalgo </p>
                <p><input type="radio" name="R1" value="d" onclick="Engine(1,value)"/>d) Percy Gibson </p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) Abraham Valdelomar</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) Jose Santos Chocano</p>
                <p><input type="radio" name="R3" value="d" onclick="Engine(3,value)"/>d) Percy Gibson</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>5.- Valdelomar es considerado "padre del cuento peruano" por: </p>

            </div>
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a) Hablar sobre animales. </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) Ser el primero en escribir un cuento</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) N.A</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) Tomar temas provincianos en sus cuentos</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>6.- No es un poema de "El poeta niño"</p>
            </div>
            <div class="panel-body">
