...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">EL SUSTANTIVO</h3>
        <div class="panel panel-default">
            <div class="panel-heading">

                <p>1.- Pero, sin embargo, mas ... Son</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R1" value="a" onclick="Engine(1,value)"/>a) Adverbios/p>
                <p><input type="radio" name="R1" value="b" onclick="Engine(1,value)"/>b) Conjunciones consecutivas</p>
                <p><input type="radio" name="R1" value="c" onclick="Engine(1,value)"/>c) Preposiciones </p>
                <p><input type="radio" name="R1" value="d" onclick="Engine(1,value)"/>d) Contradicciones gramaticales </p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) Si</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) Aunque</p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) Cabe</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) Tras </p>
                <p><input type="radio" name="R3" value="d" onclick="Engine(3,value)"/>d) So</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R4" value="b" onclick="Engine(4,value)"/>b) por-entre-luego-con </p>
                <p><input type="radio" name="R4" value="c" onclick="Engine(4,value)"/>c) apenas-cabe-sin-yo </p>
                <p><input type="radio" name="R4" value="d" onclick="Engine(4,value)"/>d) Supe-el-cada-y</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a)3 </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) 4</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) 5</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) 2</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R6" value="b" onclick="Engine(6,value)"/>b) 6</p>
