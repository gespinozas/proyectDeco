...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">FILOSOFIA ANTIGUA</h3>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R1" value="b" onclick="Engine(1,value)"/>b) Dianoia</p>
                <p><input type="radio" name="R1" value="c" onclick="Engine(1,value)"/>c) Pistis </p>
                <p><input type="radio" name="R1" value="d" onclick="Engine(1,value)"/>d) Episteme</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>4.- Hizo una distinción entre forma y materia</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R4" value="a" onclick="Engine(4,value)"/>a) Aristóteles</p>
                <p><input type="radio" name="R4" value="b" onclick="Engine(4,value)"/>b) Anaxágoras </p>
                <p><input type="radio" name="R4" value="c" onclick="Engine(4,value)"/>c) Thales </p>
                <p><input type="radio" name="R4" value="d" onclick="Engine(4,value)"/>d) Anaximandro</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>5.- ¿Qué atribución no seria correcto con respecto al mundo de las formas de Platón?</p>

            </div>
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a) Eterno </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) Inmutable</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) N.A</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) Sustancial</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>6.- Las categorías de Acto y Potencia permiten a Aristóteles explicar</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R6" value="a" onclick="Engine(6,value)"/>a) La materia</p>
                <p><input type="radio" name="R6" value="b" onclick="Engine(6,value)"/>b) El movimiento</p>
                <p><input type="radio" name="R6" value="c" onclick="Engine(6,value)"/>c) La forma</p>
                <p><input type="radio" name="R6" value="d" onclick="Engine(6,value)"/>d) N.A</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>7.- Conforme al fundador del Liceo, el vidrio de la ventana, sería la causa:</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R7" value="a" onclick="Engine(7,value)"/>a) Final</p>
                <p><input type="radio" name="R7" value="b" onclick="Engine(7,value)"/>b) Formal</p>
                <p><input type="radio" name="R7" value="c" onclick="Engine(7,value)"/>c) Material</p>
