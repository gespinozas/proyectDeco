...
<head>
    ...
    <title>8 REGIONES NATURALES</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">8 REGIONES NATURALES</h3>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) Nevados-Picos</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) Valles estrechos-Quebradas</p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) Moquegua</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) Huaraz </p>
                <p><input type="radio" name="R3" value="d" onclick="Engine(3,value)"/>d) Ayacucho</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R4" value="b" onclick="Engine(4,value)"/>b) Tropical </p>
                <p><input type="radio" name="R4" value="c" onclick="Engine(4,value)"/>c) Templado </p>
                <p><input type="radio" name="R4" value="d" onclick="Engine(4,value)"/>d) Subtropical</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a) Chala </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) Puna</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) N.A</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) Omagua</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R6" value="b" onclick="Engine(6,value)"/>b) Rupa Rupa-paiche</p>
                <p><input type="radio" name="R6" value="c" onclick="Engine(6,value)"/>c) Yunga-Picaflor</p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R7" value="c" onclick="Engine(7,value)"/>c) Lomas</p>
