...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">RENACIMIENTO</h3>
        <div class="panel panel-default">
            <div class="panel-heading">

                <p>1.- No es personaje de Amleth</p>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) Fenix de los ingenios</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) Cisne de Avon</p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) El Globo</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) Macbeth </p>
                <p><input type="radio" name="R3" value="d" onclick="Engine(3,value)"/>d) Fenix</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>4.- Obra de Shakespeare que tiene  como tema central los celos.</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R4" value="a" onclick="Engine(4,value)"/>a) Otelo</p>
                <p><input type="radio" name="R4" value="b" onclick="Engine(4,value)"/>b) Macbeth </p>
                <p><input type="radio" name="R4" value="c" onclick="Engine(4,value)"/>c) Hamlet </p>
                <p><input type="radio" name="R4" value="d" onclick="Engine(4,value)"/>d) Romeo y Julieta</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a) Hamlet </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) Otelo</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) N.A</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) Macbeth</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>6.- Julieta obligada a casarse con:</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R6" value="a" onclick="Engine(6,value)"/>a) Mercutio</p>
                <p><input type="radio" name="R6" value="b" onclick="Engine(6,value)"/>b) Paris</p>
                <p><input type="radio" name="R6" value="c" onclick="Engine(6,value)"/>c) Romeo</p>
                <p><input type="radio" name="R6" value="d" onclick="Engine(6,value)"/>d) N.A</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>7.- Mejor amigo de Romeo:</p>
            </div>
            <div class="panel-body">
