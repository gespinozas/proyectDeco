    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R1" value="b" onclick="Engine(1,value)"/>b) Autodidacta</p>
                <p><input type="radio" name="R1" value="c" onclick="Engine(1,value)"/>c) Zar </p>
                <p><input type="radio" name="R1" value="d" onclick="Engine(1,value)"/>d) Alcalde </p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a)Comun de dos </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) Epiceno</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) Masculino</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) Femenino</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
