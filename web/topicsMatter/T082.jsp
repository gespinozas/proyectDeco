...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">MAR PERUANO</h3>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) 22 de julio 1948</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) 1 de agosto de 1947</p>
                <p><input type="radio" name="R2" value="d" onclick="Engine(2,value)"/>d) N.A</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>3.- La mayor fosa submarina en el mar peruano se encuentra frente a departamento de:</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R3" value="a" onclick="Engine(3,value)"/>a) Cajamarca</p>
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) Tacna</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) Huaraz </p>
                <p><input type="radio" name="R3" value="d" onclick="Engine(3,value)"/>d) Tumbes</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>5.- Es uno de los factores que permite la frialdad del mar peruano:</p>

            </div>
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a) Calor verdoso </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) Baja latitud</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) N.A</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) Afloramiento</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>6.- Es el tipo de clima que produce la corriente Peruana sobre la costa centro y sur del Peru</p>
            </div>
            <div class="panel-body">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>7.- La corriente Peruana presenta un desplanzamiento de :</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R7" value="a" onclick="Engine(7,value)"/>a) N-S</p>
                <p><input type="radio" name="R7" value="b" onclick="Engine(7,value)"/>b) SW-NE</p>
                <p><input type="radio" name="R7" value="c" onclick="Engine(7,value)"/>c) SE-NW</p>
