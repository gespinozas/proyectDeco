...
<head>
    ...
    <title>CALCULO DE LIMITES</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Page Heading -->
        <h3 align="center">CALCULO DE LIMITES</h3>
        <div class="panel panel-default">
            <div class="panel-heading">

                <p>1.- Calcular ((x+1)^(1/3) -1) / ((x+1)^(1/2) -1) </p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R1" value="a" onclick="Engine(1,value)"/>a) 2/3</p>
                <p><input type="radio" name="R1" value="b" onclick="Engine(1,value)"/>b) 1/5</p>
                <p><input type="radio" name="R1" value="c" onclick="Engine(1,value)"/>c) 7/2 </p>
                <p><input type="radio" name="R1" value="d" onclick="Engine(1,value)"/>d) 3/5</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>2.- Calcular:  (a^3 -  5a^2 + 3a +9)/(a^3 - 7a^2 + 15a -9), cuando a tiende a 3</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R2" value="a" onclick="Engine(2,value)"/>a) 3</p>
                <p><input type="radio" name="R2" value="b" onclick="Engine(2,value)"/>b) 1/2</p>
                <p><input type="radio" name="R2" value="c" onclick="Engine(2,value)"/>c) 2</p>
                <p><input type="radio" name="R2" value="d" onclick="Engine(2,value)"/>d) 1/5</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <p>3.- Calcular:  (|x^2 -5x| -6)/((3-x)(7 -|x +4|)^(1/2)), cuando a tiende a 3</p>
            </div>
            <div class="panel-body">
                <p><input type="radio" name="R3" value="a" onclick="Engine(3,value)"/>a) -2 </p>
                <p><input type="radio" name="R3" value="b" onclick="Engine(3,value)"/>b) N.A</p>
                <p><input type="radio" name="R3" value="c" onclick="Engine(3,value)"/>c) 0 </p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R4" value="c" onclick="Engine(4,value)"/>c) -1 </p>
                <p><input type="radio" name="R4" value="d" onclick="Engine(4,value)"/>d) 1/2</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                <p><input type="radio" name="R5" value="a" onclick="Engine(5,value)"/>a) e^2 </p>
                <p><input type="radio" name="R5" value="b" onclick="Engine(5,value)"/>b) e^3</p>
                <p><input type="radio" name="R5" value="c" onclick="Engine(5,value)"/>c) 1</p>
                <p><input type="radio" name="R5" value="d" onclick="Engine(5,value)"/>d) e</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R6" value="b" onclick="Engine(6,value)"/>b) e^-2</p>
                <p><input type="radio" name="R6" value="c" onclick="Engine(6,value)"/>c) e^3</p>
                <p><input type="radio" name="R6" value="d" onclick="Engine(6,value)"/>d) e</p>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <p><input type="radio" name="R7" value="b" onclick="Engine(7,value)"/>b) e^-2 </p>
                <p><input type="radio" name="R7" value="c" onclick="Engine(7,value)"/>c) e^-4</p>
                <p><input type="radio" name="R7" value="d" onclick="Engine(7,value)"/>d) e^-3</p>
            </div>
        </div>
        <div align="center">
