...
<head>
    ...
    <title>Razonamiento Matematico</title>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>METODO IDUCTIVO</div>
                                </div>
                            </div>
                        </div>
                        <a href="topicsMatter/T007.jsp">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>PLANTEO DE ECUACIONES I</div>
                                </div>
                            </div>
                        </div>
                        <a href="topicsMatter/T008.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">Comenzar!</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>PLANTEO DE ECUACIONES II</div>
                                </div>
                            </div>
                        </div>
                        <a href="topicsMatter/T009.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">Comenzar!</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>SERIES NUMERICAS</div>
                                </div>
                            </div>
                        </div>
                        <a href="topicsMatter/T010.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">Comenzar!</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
